...
class MessageAdapter(val context: android.content.Context, val messageList: ArrayList<com.example.positiviti.ui.theme.Message>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
