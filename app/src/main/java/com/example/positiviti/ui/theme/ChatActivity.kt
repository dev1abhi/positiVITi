...
import com.example.positiviti.MessageAdapter
import com.example.positiviti.R
...
//            }
            override fun onCancelled(error: DatabaseError) {
                // Handle the cancellation event appropriately
                Log.e("ChatActivity", "Database operation cancelled: $error")
                // TODO: Implement the desired behavior for when the database operation is cancelled
            }
